...
////            offhand.setHoverName();
//            offhand.applyComponents((DataComponentMap) Component.translatable("ts.tips.jei.offhandTip",offhand.getHoverName()));
...
//            inputItem.applyComponents((DataComponentMap) Component.translatable("ts.tips.jei.offhandTip",inputItem.getDisplayName()));
